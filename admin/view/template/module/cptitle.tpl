  	...
  	<table id="module" class="list">
    	<thead>
        	<tr style="text-align:center;">
            	...
            	<td style="font-size:18px;">Information Pages</td>
  			...
  			<tr style="text-align:center;">
  				...
  				<td style="font-size:16px;"><?php echo '<b>' . $percent_infs . $text_percent . '<br/>' . $infs . $text_out . $total_infs . '</b>' . $text_have_custom; ?></td>
