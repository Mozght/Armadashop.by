<div class="row-fluid">
	...
	<div class="span12">
		...
		<label class="radio">
			<input type="radio" name="shipping_address" value="new" id="shipping-address-new" /><?php echo $text_address_new; ?>
		</label><br>
...
<script type="text/javascript"><!--
	...
	$('#shipping-address select[name=\'country_id\']').bind('change', function() {
		...
		$.ajax({
			...
			dataType: 'json',
			beforeSend: function() {
				$('#shipping-address select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="catalog/view/theme/clearshop/images/loading.gif" alt="" /></span>');
			},
			complete: function() {
				$('.wait').remove();
			},			
