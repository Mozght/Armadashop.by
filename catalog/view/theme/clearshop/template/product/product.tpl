										...
										<?php if ($thumb || $images) { ?>
											...
											<?php if ($thumb) { ?>
												...
												<?php if($this->config->get('clearshop_status') == 1 && $this->config->get('clearshop_cloud_zoom') == 1) { 
													...
													<a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="cloud-zoom" id='image' data-options="adjustX: 10, adjustY:-4, tint:false,lensOpacity:0.2, zoomWidth:'<?php echo $zwidth ?>', zoomHeight:'<?php echo $zheight; ?>', position:'<?php echo $this->config->get('clearshop_zoom_position'); ?>', showTitle:false"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a><a href="<?php echo $popup; ?>" id="zoom-image" title=" <?php echo $heading_title; ?>" class="colorbox tooltp" ><span><i class="icon-zoom-in"></i> <?php echo $this->language->get('text_zoom'); ?></span></a>
													...
													<div class="cart">
														...
														<div class="links">
															...
															<?php if ($review_status) { ?>
																<span class="review"><a onclick="$('a[href=\'#tab-review\']').trigger('click'); $('html, body').animate({scrollTop: $('#tabs').offset().top}, 800);"  title="<?php echo $text_write; ?>" class="tooltp"><img src="catalog/view/theme/clearshop/images/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" /> <?php echo $reviews; ?></a></span>
															<?php } ?>
