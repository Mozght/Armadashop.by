...
<?php if($this->config->get('clearshop_status')== 1 && $this->config->get('clearshop_bestseller_carousel') != '') { ?>

	<div id="bestseller-products" class="box product-slider top-arrows" <?php if ($this->language->get('direction')=='rtl') echo 'style="direction:ltr;"'?>>
