...
<?php if($this->config->get('clearshop_status')== 1 && $this->config->get('clearshop_latest_carousel') != '') { ?>

	<section id="latest-products" class="product-slider top-arrows box" <?php if ($this->language->get('direction')=='rtl') echo 'style="direction:ltr;"'?>>
