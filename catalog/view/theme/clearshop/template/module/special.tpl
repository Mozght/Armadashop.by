...
<?php if($this->config->get('clearshop_status')== 1 && $this->config->get('clearshop_special_carousel') != '') { ?>

	<div id="special-products" class="product-slider top-arrows" <?php if ($this->language->get('direction')=='rtl') echo 'style="direction:ltr;"'?>>
...
<?php } else { ?>
	...
	<div id="special-products" class="box">
