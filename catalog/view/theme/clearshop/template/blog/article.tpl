						...
						<?php if ($socMedia || $artRelateds || $prodRelateds) { ?>
							<div class="articleBottom">
								...
								<?php if ($prodRelateds) { ?>
									...
									<div class="contentset center">
										<h4 class="inner">
										<span><?php echo $text_related_product; ?></span>
										</h4>
									</div>						
										...
										<div class="grid-box <?php echo $xclass; ?>">
											<div class="inner">
												...
												<?php if ($prodRelated['price'] && $prodRelated['special']) { ?>
												<span class="onsale">
												...
												<?php } ?>
												<div class="cart"><a onclick="addToCart('<?php echo $prodRelated['product_id']; ?>');" class="btn btn-small btn-cart"><span><?php echo $button_cart; ?></span></a></div>
											</div>
											</div>
										<?php $counter++; } ?>
										</div>
							...
							<div id="articleComments">
								...
								<div id="commentRespond">
									...
									<div id="commentInput">
										...
										<div class="right"><a id="submitComment" class="btn btn-inverse"><span><?php echo $button_submit; ?></span></a></div>
									</div>
								</div>
							</div>
						<?php } ?>
