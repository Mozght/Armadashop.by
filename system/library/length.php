...
class Length {
	...
	public function __construct($registry) {
		...
		$length_class_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "length_class mc,  " . DB_PREFIX . "length_class_description mcd  WHERE mcd.language_id = '" . (int)$this->config->get('config_language_id') . "'AND mc.length_class_id = mcd.length_class_id");
