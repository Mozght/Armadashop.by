...
class Weight {
	...
	public function __construct($registry) {
		...
		$weight_class_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "weight_class wc, " . DB_PREFIX . "weight_class_description wcd  WHERE wcd.language_id = '" . (int)$this->config->get('config_language_id') . "'AND wc.weight_class_id = wcd.weight_class_id");
