          ...
          <thead>
            <tr>
              ...
              <td class="right"><?php if ($sort == 'cg.sort_order') { ?>
                ...
                <?php } ?></td>                
<?php // BOF - Zappo - Group Discounts - ONE LINE - Added Discounts ?>
...
<?php // BOF - Zappo - Group Discounts - ONE LINE - Added Discounts ?>
              <td class="right"><?php if ($customer_group['discount'] !== '') echo $customer_group['discount'] . ' @ ' . $customer_group['discount_minimum']; ?></td>
