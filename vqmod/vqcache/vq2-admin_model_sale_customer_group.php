...
// BOF - Zappo - Group Discounts - ONE LINE - Clear Product Cache
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "customer_group SET discount = '" . (($data['discount'] != '') ? (float)$data['discount'] : '') . '@' . (($data['discount_minimum'] != '') ? (float)$data['discount_minimum'] : '') . "', approval = '" . (int)$data['approval'] . "', company_id_display = '" . (int)$data['company_id_display'] . "', company_id_required = '" . (int)$data['company_id_required'] . "', tax_id_display = '" . (int)$data['tax_id_display'] . "', tax_id_required = '" . (int)$data['tax_id_required'] . "', sort_order = '" . (int)$data['sort_order'] . "'");
...
// BOF - Zappo - Group Discounts - ONE LINE - Clear Product Cache
		$this->cache->delete('product');
		$this->db->query("UPDATE " . DB_PREFIX . "customer_group SET discount = '" . (($data['discount'] != '') ? (float)$data['discount'] : '') . '@' . (($data['discount_minimum'] != '') ? (float)$data['discount_minimum'] : '') . "', approval = '" . (int)$data['approval'] . "', company_id_display = '" . (int)$data['company_id_display'] . "', company_id_required = '" . (int)$data['company_id_required'] . "', tax_id_display = '" . (int)$data['tax_id_display'] . "', tax_id_required = '" . (int)$data['tax_id_required'] . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE customer_group_id = '" . (int)$customer_group_id . "'");
