...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_welcome'] = sprintf(
		...
		$this->data['text_logged'] = sprintf(
		  ...
		  , $this->url->link('account/account', '', 'SSL'), $this->customer->getFirstName(), $this->url->link('account/logout', '', 'SSL'));
		...
		$categories = $this->model_catalog_category->getHeaderCategories(0);
		...
		*/
		...
		foreach ($categories as $category) {
			if ($category['top'] ) {
				...
				// Level 2
				$children_data = array();				
				$children = $this->model_catalog_category->getHeaderCategories($category['category_id']);
...
$this->data['mobilemenu_block'] = $module = $this->getChild('module/category_accordion', array(
		));
    	$this->render();
	} 	
}
