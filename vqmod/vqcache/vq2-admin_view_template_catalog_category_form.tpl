...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-discounts"><?php echo $text_discounts; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a></div>
...
<tr><td><?php echo $entry_cptitle; ?></td><td><input type="text" id="cpinfo" name="category_description[<?php echo $language['language_id']; ?>][cptitle]" size="100" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['cptitle'] : ''; ?>" /></td></tr>
              <tr>
...
<?php // BOF - Zappo - Group Discounts - Discounts Tab ?>
...
<?php // EOF - Zappo - Group Discounts - Discounts Tab ?>
        <div id="tab-design">
          <table class="list">
            <thead>
              <tr>
...
<script type="text/javascript" src="view/javascript/jquery/charCount.js"></script><script type="text/javascript">$(document).ready(function(){$("#cpinfo").charCount();});</script><style>.counter{margin-left:20px;}.counter.exceeded {font-weight:bold;color:#FC1501}.optimum{margin-left:25px;color:#55AE3A;font-weight:bold;}</style>
