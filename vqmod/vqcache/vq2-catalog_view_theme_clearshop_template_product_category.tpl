											...
											<div class="inner">
												...
												<div class="inner2" itemscope itemtype="http://schema.org/Product">
													...
													<?php if ($product['thumb']) { ?>
														<div class="image"><a href="<?php echo $product['href']; ?>"><img  itemprop="image" src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a></div>
													<?php } ?>
				...
				<div class="quickview" style="visibility:hidden;"><a id="qv<?php echo $product['product_id']; ?>" class="button" href="<?php echo $product['href']; ?>" onClick="ajaxDialog('index.php?route=product/quickview&amp;product_id=<?php echo $product['product_id']; ?>','quickview'); return false;"><?php echo $this->language->get('text_quickview'); ?> <i class="icon-share-alt"></i></a></div>
													...
													<?php if ($product['price']) { ?>
														...
														<div class="price" itemprop="price">
															...
															<?php } else { ?>
																<span class="price-old" itemprop="price"><?php echo $product['price']; ?></span>
																<span class="price-new" itemprop="price"><?php echo $product['special']; ?></span>
															<?php } ?>
