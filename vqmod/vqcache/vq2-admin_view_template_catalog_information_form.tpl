...
<tr>
              <td><?php echo $entry_cptitle; ?></td><td><input type="text" id="cpinfo" name="information_description[<?php echo $language['language_id']; ?>][cptitle]" size="100" value="<?php echo isset($information_description[$language['language_id']]) ? $information_description[$language['language_id']]['cptitle'] : ''; ?>" /></td></tr>
              <tr>
