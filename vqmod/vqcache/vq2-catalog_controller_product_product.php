...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		$download_file = $this->model_catalog_download->getDownloads($product_id);
		
		$this->data['file_mask'] = $download_file;
		...
		if ($product_info) {
			...
			if (!empty($product_info['cptitle'])){$this->document->setTitle($product_info['cptitle']);} else { $this->document->setTitle($product_info['name']);}
