...
// BOF - Zappo - Group Discounts - ONE LINE - Added Discounts and Minimum amount
			$discount = (isset($result['discount']) && $result['discount']) ? explode('@', $result['discount']) : array('', '');
			$this->data['customer_groups'][] = array(
...
// BOF - Zappo - Group Discounts - TWO LINES - Added Discounts and Minimum amount
				'discount'          => $discount[0],
				'discount_minimum'  => $discount[1],
				'action'            => $action
			);
		}	
	
// BOF - Zappo - Group Discounts - Check if Customer Group Discounts is installed
...
// BOF - Zappo - Group Discounts - ONE LINE - Added Discounts
...
// BOF - Zappo - Group Discounts - Added Discount
